...
import { servicesData } from '@views/pages/services/service-v2/data'

@Component({
  selector: 'apcs-services',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './apcs.services.component.html',
  styles: ``,
})
export class APCSServicesComponent {
